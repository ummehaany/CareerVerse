...
export function buildQuestionsSystemPrompt(): string {
  return [
    ...
    "",
    "Rules:",
    "- Generate the requested number of distinct questions for the given role and level.",
    "- Mix behavioral and role-specific/technical questions appropriate to the level.",
...
export function buildEvaluationSystemPrompt(): string {
  return [
    ...
    "- Provide an overallScore from 0 to 100, a short summary, key strengths, and concrete improvements.",
