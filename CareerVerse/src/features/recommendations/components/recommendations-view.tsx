    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div className="space-y-1">
        ...
        <p className="max-w-xl text-sm text-muted">
          Your Top 5 career paths, matched to your assessment by AI.
        </p>
      </div>
      {children}
    </div>
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        {!data.aiConfigured && (
          <Alert variant="info">
            ...
            your environment to enable recommendations.
          </Alert>
        )}
        ...
        <Card className="flex flex-col items-center gap-4 py-14 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="mx-auto max-w-md text-sm text-muted">
              Our AI will analyze your assessment and suggest the five careers that fit you best —
              with match scores, salary ranges, and next steps.
            </p>
          </div>
